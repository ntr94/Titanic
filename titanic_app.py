...
st.sidebar.image('image (2).png', width=300)
st.sidebar.write('---')
...
if index == 'Main Page':
    ...
    st.image('descarga.png', width=700)
...
#SURVIVED COLUMN 
    ...
    with row1_1:
        ...
        st.image('Survived_count.png', width=600)
    ...
    with row1_2:
        ...
        st.image('Survived_%.png', width=450)
...
#Second row
    with row1_1:
        ...
        st.image('Survived_sex.png', width=600)
    ...
    with row1_2:
        ...
        st.image('Survived_sex%.png', width=520)
...
#Third row
    with row1_1:
        ...
        st.image('Survived_class.png', width=600)
    ...
    with row1_2:
        ...
        st.image('Suivived_embarked.png', width=600)
...
#Fourth row
    with row1_1:
        ...
        st.image('Survived_age_fare.png', width=700)
...
#PCLASS COLUMN 
    ...
    with row2_1:
        ...
        st.image('Pclass_count.png', width=600)
    ...
    with row2_2:
        ...
        st.image('Pclass_%.png', width=500)
    ...
    with row2_1:
        ...
        st.image('Pclass_sex.png', width=550)
    ...
    with row2_2:
        ...
        st.image('Pclass_age.png', width=550)
    ...
    with row2_1:
        ...
        st.image('Pclass_embarked.png', width=550)
    ...
    with row2_2:
        ...
        st.image('Pclass_fareembarked.png', width=620)
...
#SEX COLUMN 
    ...
    with row3_1:
        ...
        st.image('Sex_count.png', width=550)
    ...
    with row3_1:
        ...
        st.image('Sex_faresurvived.png', width=550)
    ...
    with row3_2:
        ...
        st.image('Sex_agepclass.png', width=550)
...
#AGE COLUMN 
    ...
    with row4_1:
        ...
        st.image('Age_count.png', width=580)
    ...
    with row4_2:
        ...
        st.image('Age_pclass.png', width=750)
...
#Second row
    with row4_1:
        ...
        st.image('Age_Fare.png', width=560)
    ...
    with row4_2:
        ...
        st.image('Age_survivedfare.png', width=550)
...
#SIBSP COLUMN 
    ...
    with row5_1:
        ...
        st.image('SibSp_Survived.png', width=580)
    ...
    with row5_2:
        ...
        st.image('SibSp_Sex.png', width=580)
    ...
    with row5_1:
        ...
        st.image('SibSp_age.png', width=580)
    ...
    with row5_2:
        ...
        st.image('SibSp_fare.png', width=580)
    ...
    with row5_1:
        ...
        st.image('SibSp_Embarked.png', width=580)
...
#PARCH COLUMN 
    ...
    with row6_1:
        ...
        st.image('Parch_survived.png', width=580)
    ...
    with row6_2:
        ...
        st.image('Parch_Sex.png', width=580)
   ...
   #Second row
    with row6_1:
        ...
        st.image('Parch_Embarked.png', width=580)
...
#FARE COLUMN 
    ...
    with row7_1:
        ...
        st.image('Fare_survived.png', width=680)
    ...
    with row7_2:
        ...
        st.image('Sex_faresurvived.png', width=580)
...
#Second row
    with row7_1:
        ...
        st.image('Pclass_fareembarked.png', width=680)
    ...
    with row7_2:
        ...
        st.image('Age_survivedfare.png', width=620)
    ...
    with row8_1:
        ...
        st.image('Embarked_count.png', width=680)
    ...
    with row8_2:
        ...
        st.image('Embarked_%.png', width=580)
...
#Second row
    with row8_1:
        ...
        st.image('Embarked_survived.png', width=720)
    ...
    with row8_2:
        ...
        st.image('Pclass_embarked.png', width=560)
...
#Third row
    with row8_1:
        ...
        st.image('Pclass_fareembarked.png', width=720)
